...
class PoseEstimator:
    def __init__(self, opt, device):
        ...
        # Known 2D <-> 3D correspondences # ANCHOR2
        ...
        # # Known 2D <-> 3D correspondences # Anchor_side
        # anchor_keypoints_2D = np.array([
        #     [963, 266],
        #     [930, 263],
        #     [954, 233],
        ...
        # # Leader's 3D coordinates (anchor frame) # In Camera's coordinate frame # Anchor_side
        ...
        # # Leader's 3D coordinates (anchor frame) # In my custom coordinate frame # ANCHOR2
        # anchor_keypoints_3D = np.array([
        #     [0.042, 0.014, -0.000],#
        #     [-0.011, -0.025, 0.014],#
        #     [-0.011, -0.049, 0.016],#
        ...
        # Leader's 3D coordinates (anchor frame) # In Camera's coordinate frame # ANCHOR2
        anchor_keypoints_3D = np.array([
            [-0.014,  0.000,  0.042],
            [ 0.025, -0.014, -0.011],#[-0.011, -0.025, 0.014]
            [ 0.049, -0.016, -0.011],
            [-0.014,  0.000, -0.042],
            [-0.014,  0.000,  0.156],
            [-0.023,  0.000, -0.065],
