...
# #     def correct(self, tvec, R, measurement_cov=None):
# #         """
# #         Correct the Kalman filter state with new measurements.

# #         Args:
# #             tvec (np.ndarray): Translation vector (3x1).
# #             R (np.ndarray): Rotation matrix (3x3).
# #             measurement_cov (np.ndarray, optional): Measurement noise covariance matrix (6x6).
# #         """
...
# #         # Update the measurement noise covariance dynamically if provided
# #         if measurement_cov is not None:
# #             self.kf.measurementNoiseCov = measurement_cov
