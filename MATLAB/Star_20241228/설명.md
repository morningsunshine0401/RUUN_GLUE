...
- 상대 위치: 
  \[
  \mathbf{t}_{\text{tgt in cam}} = \mathbf{R}_{\text{cam}}^\top \cdot (\mathbf{p}_{\text{tgt}} - \mathbf{p}_{\text{cam}})
  \]

- 상대 회전: 
  \[
  \mathbf{R}_{\text{tgt in cam}} = \mathbf{R}_{\text{cam}}^\top \cdot \mathbf{R}_{\text{tgt}}
  \]
