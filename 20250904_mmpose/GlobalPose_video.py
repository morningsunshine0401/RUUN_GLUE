...
class RTMPosePoseEstimator:
    ...
    def _init_ground_truth(self):
        ...
        if self.args.calibration:
            try:
                ...
                # Using logic from VAPE_MK53_Core_GT_V3.py
    ...
    def _detect_charuco_pose(self, frame):
        ...
        # Use the new detector system from VAPE_MK53_Core_GT_V3.py
    ...
    def _detect_rtmpose_keypoints(self, cropped_frame, bbox, frame_id, t_capture):
        ...
        results = inference_topdown(self.rtmpose_model, letterboxed, np.array([[0, 0, 512, 384]]))
    ...
    def letterbox_black(self, image, new_size=(512, 384)):
        h, w = image.shape[:2]
