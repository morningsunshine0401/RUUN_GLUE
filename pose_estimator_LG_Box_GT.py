...
class PoseEstimator:
    def __init__(self, opt, device):
        ...
        ################################################################
        # # Known 2D and 3D correspondences (pre-defined): TAIL
        # anchor_keypoints_2D = np.array([
    ...
    def estimate_pose(self, mkpts0, mkpts1, mpts3D, mconf, frame, frame_idx, frame_keypoints):
        ...
        #     reprojectionError=2,#reprojectionError,
        #     confidence=0.99,#confidence,
        #     iterationsCount=2500,#iterationsCount,
        ...
        success, rvec, tvec, inliers = cv2.solvePnPRansac(
            ...
            cameraMatrix=K,
            distCoeffs=distCoeffs,
            reprojectionError=3,#reprojectionError,
            confidence=0.99,#confidence,
