...
import cv2
from pose_estimator_fast import PoseEstimator
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--resize', type=int, nargs='+', default=None,
        help='Resize the input image before running inference. If not specified, no resizing will be applied.'
    )
    ...
    if opt.resize is None:
        ...
        if len(opt.resize) == 2:
            ...
            raise ValueError('Invalid --resize option provided.')
