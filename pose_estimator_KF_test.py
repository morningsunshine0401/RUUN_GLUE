...
from KF_20250130 import KalmanFilterPose
...
class PoseEstimator:
    ...
    def _kalman_filter_update(
        ...
        max_orientation_jump = 30000#25#50#25  # degrees
        min_inlier = 7

        # ---------------------------
        coverage_threshold = -1#0.4#0.45#-1#0.6#0.6  # e.g., need at least 0.55 coverage to trust this frame
