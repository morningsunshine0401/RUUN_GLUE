...
class EnhancedMultiRefAnnotator:
    ...
    def __init__(self, reference_config_path, output_dir="annotations", device='auto', object_name="aircraft", debug=False,
                 ...
                 # NEW: Bounding Box Padding Parameters
                 ...
                 # NEW: Separate strategy for COCO dataset (can be different from visualization)
        ...
        # --- NEW: Bounding Box Padding Configuration ---
    ...
    def _calculate_padded_bbox(self, points, image_shape, strategy_name=""):
        """
        NEW: Calculate a bounding box from points with configurable padding.
    ...
    def _visualize_enhanced_keypoints(self, image_path, matched_keypoints, all_robust_matches, debug_info=None):
        ...
        # NEW: Draw bounding box based on VISUALIZATION strategy (not COCO strategy)
    ...
    def create_coco_annotation(self, image_path, matched_keypoints, ref_id, all_robust_matches):
        ...
        min_required = max(4, ref_visible_count - 1)
        ...
        # NEW: Use COCO strategy (can be different from visualization strategy) with padding
        bbox_points = None
...
def main():
    parser = argparse.ArgumentParser(description='Ultimate Auto Annotator with ROI-constrained fallbacks and padded bounding boxes.')
    ...
    # NEW: Bounding box padding arguments
